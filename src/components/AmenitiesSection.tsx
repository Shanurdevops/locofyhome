...
const AmenitiesSection: FunctionComponent<AmenitiesSectionType> = ({
  ...
  const kitchenFeaturesStyle: CSSProperties = useMemo(() => {
    return {
      width: propWidth,
    };
  }, [propWidth]);
  ...
  const propertyFeaturesStyle: CSSProperties = useMemo(() => {
    return {
  ...
  return (
    <div className={styles.amenitiessection1} style={amenitiesSection1Style}>
      ...
      <div className={styles.kitchenFeatures} style={kitchenFeaturesStyle}>
        <img
      ...
      <div className={styles.propertyFeatures} style={propertyFeaturesStyle}>
        <img
      ...
      <div className={styles.connectivityFeatures}>
        <img
